            ...
            <form action="<?php echo $this->base->url.'/admin/posts.php?action=save'; ?>" method="POST">
             <?php foreach($posts as $post): ?>
                ...
                <div class="editor-header">
                    ...
                    <p class="mb-0">Редактирование сообщения №<?php echo htmlspecialchars($post['id']); ?></p>
                </div>
                ...
                <div class="editor-body">                  
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text"  name="post[title]" class="form-control form-control-lg" id="postTitle" placeholder="Введите заголовок поста" value="<?php echo htmlspecialchars($post['title']); ?>">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4 wmd-panel">
                            ...
                            <textarea class="form-control editor-textarea wmd-input" id="wmd-input" name="post[content]" placeholder="Начните писать свой пост здесь..."><?php echo htmlspecialchars($post['content']); ?></textarea>
                        </div>
